...
<body class="bg-light">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 my-3">
                <div class="card border-0 shadow" style="max-width: 350px; margin:auto;">
                    <img src="../public/images/rooms/2.jpg" class="card-img-top">
                    <div class="card-body">
                        <h5>Double Room</h5>
                        <h5 class="mb-4">From $200 per night</h5>
                        <div class="features mb-4">
                            <h6 class="mb-1">Room Details</h6>
            ...
            <div class="col-lg-4 col-md-6 my-3">
                <div class="card border-0 shadow" style="max-width: 350px; margin:auto;">
                    <img src="../public/images/rooms/3.jpeg" class="card-img-top">
                    <div class="card-body">
                        <h5>Family Suite</h5>
                        <h5 class="mb-4">From $250 per night</h5>
                        <div class="features mb-4">
                            <h6 class="mb-1">Room Details</h6>
